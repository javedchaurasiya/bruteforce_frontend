...
function Socials(props) {
  ...
  return (
    <div className="main-social">
      ...
      <a
        style={{ marginTop: 10 }}
        href={"http://linkedin.com/in/" + socialDetails.linkedin}
      >
      ...
      <a
        style={{ marginTop: 8 }}
        href={"http://github.com/" + socialDetails.github}
      >
        <GitHubIcon sx={{ fontSize: 17 }} />
        <span style={{ marginLeft: 5, fontSize: "13px" }}>
          {socialDetails.github}
        </span>
      </a>
      <a
        style={{ marginTop: 8 }}
        href={"http://twitter.com/" + socialDetails.twitter}
      >
